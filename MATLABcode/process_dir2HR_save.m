function process_dir2HR_save(num_shingles, thresh, print_flag)

% PROCESS_DIR2HR_SAVE processes directories of files for
...
for i = 1:length(out_file_lst)
    ...
    file2HR_save(inname, outname, num_shingles, thresh)
end
