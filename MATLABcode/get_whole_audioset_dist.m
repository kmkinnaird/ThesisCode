function out_mat = ...
    get_whole_audioset_dist(comp_flag, num_shingles, save_flag)

% GET_WHOLE_AUDIOSET_DIST computes the matrix of pairwise comparisons
% between the representations (or lists of representations) in a directory
% based on audio files.
%
...
if comp_flag == 1
    ...
    if save_flag == 1
        outname = ['/Users/katiek/Desktop/CurrentCode/MusicFiles/',...
            'MATfiles/ShingleNumber', num2str(num_shingles), ...
            '/compmat.mat'];
