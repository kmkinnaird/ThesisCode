function process_dir2partials_audio_save(num_shingles, thresh, print_flag)

% PROCESS_DIR2PARTIALS_AUDIO_SAVE processes directories of files based on
% audio for NUM_SHINGLES, a specific number of feature vectors per shingle,
% given THRESH, a particular threshold.
%
...
for i = 1:length(out_file_lst)
    ...
    file2partials_save_audio(inname, outname, num_shingles, thresh)
end
